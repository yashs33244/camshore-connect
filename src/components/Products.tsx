...
const Products = () => {
  ...
  return (
    <section
      id="products"
      className="py-20 bg-gradient-to-br from-[#F2FCE2] to-white"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our comprehensive range of cutting-edge security products
              ...
              >
                <Card className="mx-2 overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <CardHeader className="relative z-10 bg-white/95 backdrop-blur-sm">
                    <div className="flex items-center gap-3 mb-2">
                      {React.createElement(getIconComponent(product.name), {
                ...
                {index < products.length - 1 && (
                  <Separator
                    ...
                    className="absolute right-0 top-1/4 h-1/2 bg-gray-200"
                  />
                )}
              </CarouselItem>
            ))}
